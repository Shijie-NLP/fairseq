...
class DummyMaskedLMConfig(FairseqDataclass):
    ...
    tokens_per_sample: int = field(
        default=512,
        metadata={"help": "max number of total tokens over all segments per sample for BERT dataset"},
    )
        ...
        self.datasets[split] = DummyDataset(
            {
                ...
                "net_input": {
                    ...
                    "src_lengths": torch.full((bsz,), self.cfg.tokens_per_sample, dtype=torch.long),
                },
