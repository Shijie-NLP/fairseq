...
class MultilingualDenoisingConfig(DenoisingConfig):
    ...
    no_whole_word_mask_langs: str = field(
        default="",
        metadata={"help": "languages without spacing between words don't support whole word masking"},
    )
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        for language in languages:
            ...
            lang_dataset = DenoisingDataset(
                ...
                eos=None if not self.cfg.add_lang_token else self.source_dictionary.index("[{}]".format(language)),
            )
