...
class MultilingualTranslationTask(LegacyFairseqTask):
    ...
    def prepare(cls, args, **kargs):
        ...
        sorted_langs = sorted(x for lang_pair in args.lang_pairs for x in lang_pair.split("-"))
    ...
    def load_dataset(self, split, epoch=1, **kwargs):
        ...
        self.datasets[split] = RoundRobinZipDatasets(
            OrderedDict([(lang_pair, language_pair_dataset(lang_pair)) for lang_pair in self.lang_pairs]),
                ...
                [
                    (
                        ...
                        self.alter_dataset_langtok(
                            LanguagePairDataset(src_tokens, src_lengths, self.source_dictionary),
