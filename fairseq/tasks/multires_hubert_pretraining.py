...
class MultiresHubertPretrainingTask(FairseqTask):
    ...
    @classmethod
    def setup_task(cls, cfg: MultiresHubertPretrainingConfig, **kwargs) -> "MultiresHubertPretrainingTask":
        return cls(cfg)
    ...
    def load_dictionaries(self):
        ...
        dictionaries = [
            (Dictionary.load(f"{label_dir}/dict.{label}.txt") if label != "" else None) for label in self.cfg.labels
        ]
