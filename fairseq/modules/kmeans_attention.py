...
class SelfAttention(nn.Module):
    def __init__(
        ...
        assert not (receives_context and local_attn_heads > 0), (
    ...
    def forward(
        self, query, key, value, context=None, key_padding_mask=None, context_mask=None, pos_emb=None, **kwargs
    ):
        assert not (self.receives_context and not exists(context)), (
